...
const FoodListing = () => {
  ...
  const [selectedCategories, setSelectedCategories] = useState(location.state?.selectedCategory ? [location.state.selectedCategory] : []); // Default selected categories
